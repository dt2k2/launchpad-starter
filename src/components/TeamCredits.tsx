...
const BOTS = ["Lovable", "Claude", "ChatGPT", "Generative Voice AI"];
...
export function TeamCredits() {
  return (
    <div className="fixed left-4 top-4 z-40 select-none font-sans">
      ...
      >
        <div className="mb-3">
          <p className="text-[10px] font-medium uppercase tracking-[0.3em] text-amber-200/80">Tên Môn Học</p>
          <p className="text-[13px] font-medium text-white">MLN111</p>
        </div>

        <div className="mb-3">
          <p className="text-[10px] font-medium uppercase tracking-[0.3em] text-amber-200/80">Tên Lớp</p>
